    ...
    <div className="space-y-6 animate-fade-in font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-zinc-950 rounded-2xl p-5 border border-zinc-800/80 shadow-xl">
          ...
          <div className="text-3xl font-bold font-sans text-white mt-3 tracking-tight">
        ...
        <div className="bg-white text-black rounded-2xl p-5 border border-white shadow-2xl">
          <div className="text-[11px] font-mono font-bold uppercase tracking-wider text-zinc-600">
            Broker Net Retained
          </div>
          <div className="text-3xl font-bold font-sans text-black mt-3 tracking-tight">
            ${netBrokerPayout.toLocaleString('en-US', { minimumFractionDigits: 2 })}
          </div>
          <p className="text-xs font-mono font-semibold text-zinc-800 mt-2">
      ...
      <div className="bg-zinc-950 rounded-2xl border border-zinc-800/80 overflow-hidden shadow-2xl p-6 space-y-4">
        <div className="flex justify-between items-center pb-2 border-b border-zinc-800/80">
          ...
          <span className="text-xs font-mono font-semibold text-zinc-400 bg-zinc-900 border border-zinc-800 px-3 py-1 rounded-full">
